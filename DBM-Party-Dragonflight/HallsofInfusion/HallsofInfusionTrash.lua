...
local specWarnOceanicBreath					= mod:NewSpecialWarningDodge(375351, nil, nil, nil, 2, 2) --Океаническое дыхание
local specWarnGustingBreath					= mod:NewSpecialWarningDodge(375348, nil, nil, nil, 2, 2) --Сметающее дыхание
local specWarnTectonicBreath				= mod:NewSpecialWarningDodge(375327, nil, nil, nil, 2, 2) --Тектоническое дыхание
...
local timerOceanicBreathCD					= mod:NewCDNPTimer(18.1, 375351, nil, nil, nil, 3, nil, DBM_COMMON_L.DEADLY_ICON) --Океаническое дыхание
local timerGustingBreathCD					= mod:NewCDNPTimer(19.3, 375348, nil, nil, nil, 3) --Сметающее дыхание Could also be 18.1, but need bigger sample
local timerTectonicBreathCD					= mod:NewCDNPTimer(18.1, 375327, nil, nil, nil, 3) --Тектоническое дыхание
