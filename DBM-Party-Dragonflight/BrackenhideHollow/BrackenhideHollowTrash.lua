...
local specWarnViciousClawmangle				= mod:NewSpecialWarningRun(367484, nil, 62374, nil, 4, 2) --Жестокий коготь
...
local specWarnStinkBreath					= mod:NewSpecialWarningDodge(388060, nil, nil, DBM_COMMON_L.FRONTAL, 2, 2) --Вонючее дыхание
local specWarnToxicTrap						= mod:NewSpecialWarningDodge(368287, nil, nil, nil, 2, 2) --Ядовитая ловушка
...
local specWarnBloodthirstyCharge			= mod:NewSpecialWarningDodge(385832, nil, nil, nil, 2, 2) --Кровожадный рывок
local specWarnSummontotem					= mod:NewSpecialWarningSwitch(374057, "Dps", nil, nil, 1, 2) --Призыв тотема
local specWarnRotchantingTotem				= mod:NewSpecialWarningSwitch(382435, "Dps", 374057, nil, 1, 2) --Тотем гниломагии
...
local specWarnDecaySurge					= mod:NewSpecialWarningInterrupt(382474, "HasInterrupt", nil, nil, 1, 2) --Всплеск гнили
local specWarnScreech						= mod:NewSpecialWarningInterrupt(385029, "HasInterrupt", nil, nil, 1, 2) --Визг
local specWarnNecroticBreath				= mod:NewSpecialWarningDodge(382712, nil, nil, DBM_COMMON_L.FRONTAL, 2, 2) --Некротическое дыхание 26.7-40?
...
local timerWitheringBurstCD					= mod:NewCDNPTimer(12.7, 367503, nil, nil, nil, 3) --Губительный прорыв 19-26
