...
local specWarnConflagrantBattery			= mod:NewSpecialWarningDodge(372296, nil, nil, DBM_COMMON_L.BOMBING, 2, 2) --Огненная батарея (Обстрел)
...
local specWarnMoltenArmy					= mod:NewSpecialWarningInterrupt(383651, "HasInterrupt", nil, nil, 1, 2) --Раскаленная армия
...
local timerMoteofCombustionCD				= mod:NewCDNPTimer(16, 384161, nil, nil, nil, 3) --Частица возгорания
...
local timerScorchingFusilladeCD				= mod:NewCDNPTimer(22, 372543, nil, nil, nil, 3) --Обжигающий обстрел
local timerConflagrantBatteryCD				= mod:NewCDNPTimer(22.6, 372296, DBM_COMMON_L.BOMBING, nil, nil, 2, nil, DBM_COMMON_L.DEADLY_ICON) --Огненная батарея (Обстрел)
