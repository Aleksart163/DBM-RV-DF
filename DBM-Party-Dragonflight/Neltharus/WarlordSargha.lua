...
local specWarnTakeTreasure						= mod:NewSpecialWarningSpell(119664, nil, nil, DBM_COMMON_L.USEITEM, 3, 4) --Хватай сокровище! (Используй предмет)
local specWarnMagmaShield						= mod:NewSpecialWarningSpell(376780, nil, nil, nil, 1, 2) --Щит магмы
local specWarnDragonsKiln						= mod:NewSpecialWarningDodge(377204, nil, nil, DBM_COMMON_L.FRONTAL, 2, 2) --Драконий горн (Фронталка)
...
function mod:SPELL_CAST_START(args)
	...
	if spellId == 376780 then --Щит магмы (Щит на боссе)
		...
		specWarnMagmaShield:Play("specialsoon")
