...
--]]
local warnTitanicEmpowerment					= mod:NewSpellAnnounce(372719, 4, nil, nil, 96923) --Титаническое усиление (Титаническая мощь)
local warnTitanicEmpowermentOver				= mod:NewFadesAnnounce(372719, 1, nil, nil, 96923) --Титаническое усиление (Титаническая мощь)
...
local specWarnTitanicEmpowerment				= mod:NewSpecialWarningSpell(372719, nil, 96923, nil, 3, 4) --Титаническое усиление (Титаническая мощь)
local specWarnTitanicEmpowerment2				= mod:NewSpecialWarningInterrupt(372719, "-Healer", 96923, nil, 3, 4) --Титаническое усиление (Титаническая мощь)
...
local timerTitanicEmpowermentCD					= mod:NewCDTimer(35, 372719, 96923, nil, nil, 7, nil, DBM_COMMON_L.DEADLY_ICON, nil, 1, 5) --Титаническое усиление (Титаническая мощь)
