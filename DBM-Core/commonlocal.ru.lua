...
CL.BREAK_LOS				= "Преграде"--По идее, так будет правильнее по смыслу и склонению. Но в идеале должно быть так: "Бегите за стену". Смысл, по идее, один и тот же
...
CL.ATTRACTION				= "Притягивание"
CL.FRONTAL					= "Фронталка"
CL.LASER					= "Лазер"
CL.LASERS					= "Лазеры"
CL.RIFT						= "Разлом"
CL.RIFTS					= "Разломы"
CL.TRAPS					= "Активация ловушек"
CL.ROOTS					= "Корни"
CL.MARK						= "Метка"
CL.MARKS					= "Метки"
CL.CURSE					= "Проклятие"
...
CL.SWIRLS					= "Вихри"
CL.BOMBING					= "Обстрел"
CL.DAMAGEUP					= "Повышенный урон"
CL.USEITEM					= "Используй предмет!"
