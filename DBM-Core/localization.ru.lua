...
L.MOD_AVAILABLE						= "Для этого контента доступен дополнительный модуль %s. Вы можете скачать его с " .. DBM_CORE_PROSHLYAPATION_URL .. "."
...
L.YOUR_VERSION_OUTDATED      		= "Ваша версия " .. L.DEADLY_BOSS_MODS .. " устарела! Пожалуйста, загрузите последнюю версию на " .. DBM_CORE_PROSHLYAPATION_URL .. "."
...
L.UPDATEREMINDER_HEADER				= "Ваша версия " .. L.DEADLY_BOSS_MODS .. " устарела.\n Версия %s (%s) доступна для загрузки на " .. DBM_CORE_PROSHLYAPATION_URL .. "."
