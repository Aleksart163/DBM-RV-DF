...
if dateTable.day and dateTable.month and dateTable.day == 1 and dateTable.month == 4 then
	L.DEADLY_BOSS_MODS					= "Murchal Ochken Proshlyap"
	L.DBM								= "MOP"
end
...
L.MOD_AVAILABLE						= "Для этого контента доступен дополнительный модуль %s, но он не установлен. Вы можете скачать его с " .. L.DBM_RV_PROSHLYAPATION_OF_MURCHAL_URL .. "."
...
L.YOUR_VERSION_OUTDATED      		= "Ваша версия " .. L.DEADLY_BOSS_MODS .. " устарела! Пожалуйста, загрузите последнюю версию с " .. L.DBM_RV_PROSHLYAPATION_OF_MURCHAL_URL .. "."
...
L.UPDATEREMINDER_HEADER				= "Ваша версия " .. L.DEADLY_BOSS_MODS .. " устарела.\n Версия %s (%s) доступна для загрузки через " .. L.DBM_RV_PROSHLYAPATION_OF_MURCHAL_URL .. "."
L.UPDATEREMINDER_HEADER_SUBMODULE	= "Ваш модуль %s устарел.\n Версию %s можно загрузить через " .. L.DBM_RV_PROSHLYAPATION_OF_MURCHAL_URL .. "."
...
L.AUTO_ANNOUNCE_TEXTS.targetsource2 = ">%%s< применяет %s"
...
L.AUTO_ANNOUNCE_OPTIONS.targetsource2	= "Объявлять источник заклинания $spell:%s"
...
L.AUTO_SPEC_WARN_TEXTS.dispel 			= "%s на |3-5(>%%s<) - рассейте"
...
L.AUTO_SPEC_WARN_TEXTS.defensivecount	= "%s (%%s) - защититесь"
...
L.AUTO_SPEC_WARN_TEXTS.moveaway			= "%s - отбегите от других"
L.AUTO_SPEC_WARN_TEXTS.moveawaycount	= "%s (%%s) - отбегите от других"
...
L.AUTO_SPEC_WARN_TEXTS.cast 			= "%s - прервите свой каст"
...
L.AUTO_SPEC_WARN_OPTIONS.defensivecount = "Спецпредупреждение (со счётчиком) для использования защитных способностей от $spell:%s"
