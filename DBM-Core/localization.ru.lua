...
L.DBM_RV_FORUMS_MESSAGE				= "Нашли баг или неправильный таймер? Считаете что какому-то модулю требуется дополнительное предупреждение, таймер, особенность или локализация?\nПо всем вопросам можете обращаться на discord |h|cff3588ffAleksart163|r или оставлять запросы на |h|cff3588ffhttps://github.com/Aleksart163/DBM-RV-DF/pulls|r\n|h|cffa0000fВАЖНО!!!|r Не забывайте вовремя обновлять версию аддона, чтобы он содержал самую свежую информацию. Свежая версия всегда выходит в день сброса кд - по средам."
...
L.AUTO_ANNOUNCE_TEXTS.targetsource2  = ">%%s< использует %s"
