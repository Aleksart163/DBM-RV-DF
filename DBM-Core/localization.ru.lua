...
L.DBM_FORUMS_MESSAGE				= "Нашли баг или неправильный таймер? Считаете что какому-то модулю требуется дополнительное предупреждение, таймер, особенность или локализация?\nПо всем вопросам можете обращаться на discord Aleksart163, /w Куплиняш или оставлять запросы на |h|cff3588ffhttps://github.com/Aleksart163/DBM-RV-DF/pulls|r"
...
L.MOD_AVAILABLE						= "Для этого контента доступен дополнительный модуль %s, но он не установлен. Вы можете скачать его с " .. L.DBM_PROSHLYAPATION_OF_MURCHAL_URL .. "."
...
L.YOUR_VERSION_OUTDATED      		= "Ваша версия " .. L.DEADLY_BOSS_MODS .. " устарела! Пожалуйста, загрузите последнюю версию с " .. L.DBM_PROSHLYAPATION_OF_MURCHAL_URL .. "."
...
L.UPDATEREMINDER_HEADER				= "Ваша версия " .. L.DEADLY_BOSS_MODS .. " устарела.\n Версия %s (%s) доступна для загрузки через " .. L.DBM_PROSHLYAPATION_OF_MURCHAL_URL .. "."
L.UPDATEREMINDER_HEADER_SUBMODULE	= "Ваш модуль %s устарел.\n Версию %s можно загрузить через " .. L.DBM_PROSHLYAPATION_OF_MURCHAL_URL .. "."
