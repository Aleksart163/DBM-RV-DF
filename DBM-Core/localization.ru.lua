...
L.YOUR_VERSION_OUTDATED      		= "Ваша версия " .. L.DEADLY_BOSS_MODS .. " устарела! Пожалуйста, загрузите последнюю версию на " .. DBM_CORE_PROSHLYAPATION_OF_MURCHAL_URL .. " "
...
L.UPDATEREMINDER_HEADER				= "Ваша версия " .. L.DEADLY_BOSS_MODS .. " устарела.\n Версия %s (%s) доступна для загрузки на " .. DBM_CORE_PROSHLYAPATION_OF_MURCHAL_URL .. " "
...
L.AUTO_YELL_ANNOUNCE_TEXT.position2 = "%s %%s на {rt%%d}"..UnitName("player").."{rt%%d}"
