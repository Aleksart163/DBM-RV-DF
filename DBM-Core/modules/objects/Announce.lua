...
---@overload fun(self, spellId: number|string, color: number?, icon: number|string?, optionDefault: SpecFlags|boolean?, optionName: string|number|boolean?, castTime: number?, preWarnTime: number?, soundOption: number|boolean?, noFilter: boolean?): Announce3
function bossModPrototype:NewTargetSourceAnnounce2(spellId, color, ...)
	return newAnnounce(self, "targetsource2", spellId, color or 3, ...)
end
