...
_G.DBM = DBM
DBM.Revision = parseCurseDate("20260826000000")

local fakeBWVersion, fakeBWHash = 471, "pr05h19p"
local bwVersionResponseString = "V^%d^%s"
local PForceDisable
-- The string that is shown as version
DBM.DisplayVersion = "10.2.73"--Core version
DBM.classicSubVersion = 0
DBM.ReleaseRevision = releaseDate(2026, 8, 26) -- the date of the latest stable version that is available, optionally pass hours, minutes, and seconds for multiple releases in one day
