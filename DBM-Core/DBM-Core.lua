...
_G.DBM = DBM
DBM.Revision = parseCurseDate("20240902070000")

local fakeBWVersion, fakeBWHash = 450, "pr0sh19p"
local bwVersionResponseString = "V^%d^%s"
local PForceDisable
-- The string that is shown as version
DBM.DisplayVersion = "10.2.61"--Core version
DBM.classicSubVersion = 0
DBM.ReleaseRevision = releaseDate(2024, 8, 2) -- the date of the latest stable version that is available, optionally pass hours, minutes, and seconds for multiple releases in one day
