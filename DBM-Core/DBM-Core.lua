...
_G.DBM = DBM
DBM.Revision = parseCurseDate("20260819000000")
...
DBM.ReleaseRevision = releaseDate(2026, 8, 19) -- the date of the latest stable version that is available, optionally pass hours, minutes, and seconds for multiple releases in one day
