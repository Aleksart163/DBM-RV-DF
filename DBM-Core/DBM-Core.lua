...
local DBM = {
	Revision = parseCurseDate("20231223050000"),
}
_G.DBM = DBM
...
if isRetail then
	...
	DBM.ReleaseRevision = releaseDate(2023, 12, 23) -- the date of the latest stable version that is available, optionally pass hours, minutes, and seconds for multiple releases in one day
