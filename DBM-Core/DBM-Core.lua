...
_G.DBM = DBM
DBM.Revision = parseCurseDate("20260729000000")
...
DBM.ReleaseRevision = releaseDate(2026, 7, 29) -- the date of the latest stable version that is available, optionally pass hours, minutes, and seconds for multiple releases in one day
