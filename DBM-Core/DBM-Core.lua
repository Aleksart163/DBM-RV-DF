...
_G.DBM = DBM
DBM.Revision = parseCurseDate("20260610070000")
...
DBM.ReleaseRevision = releaseDate(2026, 6, 10) -- the date of the latest stable version that is available, optionally pass hours, minutes, and seconds for multiple releases in one day
