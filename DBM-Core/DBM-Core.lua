...
_G.DBM = DBM
DBM.Revision = parseCurseDate("20240523070000")
...
DBM.ReleaseRevision = releaseDate(2024, 5, 23) -- the date of the latest stable version that is available, optionally pass hours, minutes, and seconds for multiple releases in one day
