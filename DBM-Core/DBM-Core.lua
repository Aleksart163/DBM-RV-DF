...
_G.DBM = DBM
DBM.Revision = parseCurseDate("20250303170000")

local fakeBWVersion, fakeBWHash = 460, "pr0sh19p"
local bwVersionResponseString = "V^%d^%s"
local PForceDisable
-- The string that is shown as version
DBM.DisplayVersion = "10.2.65"--Core version
DBM.classicSubVersion = 0
DBM.ReleaseRevision = releaseDate(2025, 3, 3) -- the date of the latest stable version that is available, optionally pass hours, minutes, and seconds for multiple releases in one day
