...
DBM_CORE_PROSHLYAPATION_URL				= "https://github.com/Aleksart163/DBM-RV-DF"
...
L.MOD_AVAILABLE							= "%s is available for this zone. You can download it on " .. DBM_CORE_PROSHLYAPATION_URL .. "."
...
L.YOUR_VERSION_OUTDATED     			= "Your version of " .. L.DEADLY_BOSS_MODS .. " is out-of-date. Please download the latest version through " .. DBM_CORE_PROSHLYAPATION_URL .. "."
...
L.UPDATEREMINDER_HEADER					= "Your version of " .. L.DEADLY_BOSS_MODS.. " is out-of-date.\n Version %s (%s) is available for download through " .. DBM_CORE_PROSHLYAPATION_URL .. "."
