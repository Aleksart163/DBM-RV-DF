...
L.DBM_RV_FORUMS_MESSAGE					= "Found a bug or wrong timer? Do you think that some module needs an additional warning, timer, feature or localization? \nAny questions can be addressed to discord |h|cff3588ffAleksart163|r or leave requests at |h|cff3588ffhttps://github.com/Aleksart163/DBM-RV-DF/pulls|r\n|h|cffa0000fIMPORTANT!!! Don't forget to update the addon version in time so that it contains the latest information. A fresh version is always released on Wednesdays."
...
L.YOUR_VERSION_OUTDATED     			= "Your version of " .. L.DEADLY_BOSS_MODS .. " is out-of-date. Please download the latest version through " .. L.DBM_RV_PROSHLYAPATION_OF_MURCHAL_URL .. "."
...
L.UPDATEREMINDER_HEADER					= "Your version of " .. L.DEADLY_BOSS_MODS.. " is out-of-date.\n Version %s (%s) is available for download through " .. L.DBM_RV_PROSHLYAPATION_OF_MURCHAL_URL .. "."
