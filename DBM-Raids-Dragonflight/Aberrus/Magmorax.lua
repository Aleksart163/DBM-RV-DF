...
local specWarnIgnitingRoar							= mod:NewSpecialWarningCount(403740, nil, 316853, nil, 2, 2)
...
local timerOverpoweringStompCD						= mod:NewCDCountTimer(101.7, 403671, DBM_COMMON_L.PUSHBACK, nil, nil, 2)--"Knockback"
