...
L:SetMiscLocalization({
	Tip			= "Bad timer with the release of adds? Report it to the addon author on Discord |h|cff3588ffAleksart163|r. It is recommended to have a recorded video of the boss fight for accuracy.",
	Adds 		= "Adds",
	Next 		= "Next Attack:",
	EggsLeft 	= "Eggs left:",
	Middle 		= "Center",
...
L:SetMiscLocalization({
	...
	MurchalOchkenProshlyapen2 = "We will break their chains and restore the glory of dragonkind!",
	MurchalOchkenProshlyapen3 = "Minions of the storm, hear my call!",
	MurchalOchkenProshlyapen4 = "The Aspects's hold on us is broken! Their prison falls!",
	negative 	= "negative",
	positive 	= "positive",
...
L:SetMiscLocalization({
	...
	Fyrakk2RP = "Ashes to ashes. What a pity."
})
