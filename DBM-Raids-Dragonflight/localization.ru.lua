...
L:SetMiscLocalization({
	Tip			= "Кривой таймер с выходом аддов? Сообщи об этом автору аддона по Discord |h|cff3588ffAleksart163|r или /w |h|cff3588ffКуплиняш|r. Для точности рекомендуется иметь записанное видео боя с боссом.",
	Adds 		= "Адды",
	Next 		= "След. атака:",
