...
L:SetMiscLocalization({
	Tip			= "Кривой таймер с выходом аддов? Сообщи об этом автору аддона по Discord |h|cff3588ffAleksart163|r. Для точности рекомендуется иметь записанное видео боя с боссом.",
	Adds 		= "Адды",
	Next 		= "След. атака:",
	EggsLeft 	= "Яиц осталось:",
	Middle 		= "Центр",
	Left		= "Слева",
	Right		= "Справа",
	staff		= "Великий посох",
...
L:SetMiscLocalization({
	...
	MurchalOchkenProshlyapen2 = "Мы сорвем оковы и вернем драконам былое величие!",
	MurchalOchkenProshlyapen3 = "Прислужники бури, услышьте меня!",
	MurchalOchkenProshlyapen4 = "Конец господству Аспектов! Тюрьма разрушена!",
...
L:SetMiscLocalization({
	MurchalProshlyap1		= "Первому прототипу недоставало силы. Следующего мы наделили силой тайной магии.",
	MurchalProshlyap2		= "К несчастью, существо с нестабильной магией бесполезно. Так что мы улучшили технику слияния."
})
...
L:SetMiscLocalization({
	RP = "Наш строй сыпется, Саркарет! Нам их не сдержать!",
	RP1 = "Пламя и тьма – две великие силы.",
	RP2 = "Великолепно. Поздравляю.",
	RP3 = "Конец тысячелетиям мучений. Грядет аннигиляция!",
	RP4 = "Вот и окончилось ваше путешествие, герои."
})
...
L:SetMiscLocalization({
	Fyrakk1RP = "Это опять вы. Как жаль, что нет времени вами заняться.",
	Fyrakk2RP = "Пепел к пеплу. Какая жалость."
})
