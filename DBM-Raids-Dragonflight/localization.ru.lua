...
L:SetMiscLocalization({
	Tip			= "Кривой таймер с выходом аддов? Сообщи об этом автору аддона по Discord Aleksart163 или /w Куплиняш. Для точности рекомендуется иметь записанное видео боя с боссом.",
	Adds 		= "Адды",
	Next 		= "След. атака:",
