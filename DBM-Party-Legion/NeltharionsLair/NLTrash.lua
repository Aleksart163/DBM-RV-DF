...
local timerFractureCD					= mod:NewCDNPTimer(15.5, 193505, nil, "Tank|Healer", nil, 5, nil, DBM_COMMON_L.TANK_ICON) --Трещина Also acts as piercing shards timer, piercing is awlays used immediately after fracture
