...
local timerFanaticsRageCD			= mod:NewCDNPTimer(15, 255824, nil, nil, nil, 4, nil, DBM_COMMON_L.INTERRUPT_ICON) --Ярость фанатика 20.2
...
local timerTerrifyingScreechCD		= mod:NewCDNPTimer(15, 255041, nil, nil, nil, 4, nil, DBM_COMMON_L.INTERRUPT_ICON) --Ужасающий визг 18.2 Could be 17, watch for debug
...
local timerBulwarkofJujuCD			= mod:NewCDNPTimer(18, 253721, nil, nil, nil, 5, nil, DBM_COMMON_L.TANK_ICON) --Оплот джуджу 22.2
local timerHexCD					= mod:NewCDNPTimer(16, 252781, nil, nil, nil, 4, nil, DBM_COMMON_L.INTERRUPT_ICON) --Заразный сглаз
